...
public class HelloPicking extends AbstractAppState {
	...
	public HelloPicking(ImageView imagePanel) {
		panel = imagePanel;
	}
	...
	private void initKeys() {
		panel.addEventHandler(MouseEvent.MOUSE_PRESSED, (e)-> {
			if(e.getButton() == MouseButton.PRIMARY) {
				app.enqueue(()-> {
					HelloPicking.this.shoot(new Vector2f((float)e.getX(), (float)(e.getY()))); // y is inversed
					return null;
				});
			}
		});
